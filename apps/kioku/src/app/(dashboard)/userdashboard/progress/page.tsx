    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="flex items-center text-xs text-muted-foreground">
            <ChevronUp className="mr-1 h-4 w-4 text-green-500" />
            <span className="text-green-500 font-medium">+0.8</span> from last month
          </div>
        </CardContent>
      </Card>
    </div>
    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Your memory retention is improving</CardDescription>
        </CardHeader>
    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Topics with highest retention scores</CardDescription>
        </CardHeader>
        <CardContent className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
